...
def valid(net, valid_dataloader, hypar, epoch=0):
    ...
    for i_val, data_val in enumerate(valid_dataloader):
        ...
        for target, output in zip(labels_val_v, outputs):
            output = apply_nms(output, 0.7,0.5)
...
if __name__ == "__main__":
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model_512_new_new/{hypar['dataset']}/efficientnet-b2-mammo-clip.pth"
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model_512_new_new/{hypar['dataset']}/efficientnet-b5-mammo-clip.pth"
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model_512_new_new/{hypar['dataset']}/efficientnet-ours.pth"
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model_512_new_new/{hypar['dataset']}/lvmmed-resnet50.pth"
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model/{hypar['dataset']}/RaSE.pth"
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model/{hypar['dataset']}/RaSE_random.pth"
    ...
    hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model/{hypar['dataset']}/RaSE_Swin.pth"
    ...
    hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model/{hypar['dataset']}/RaSE_Swin_random.pth"
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model_512_new_new/{hypar['dataset']}/lvmmed.pth"
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model_512_new_new/{hypar['dataset']}/medsam.pth"
    ...
    # hypar["restore_model"] = f"{os.path.dirname(current_dir)}/Detection/saved_model/{hypar['dataset']}/ours-mammo1.pth"
